...
public:
    ...
    void setupUi(QDialog *Login)
    {
        ...
        rememberPassword->setObjectName("rememberPassword");
        rememberPassword->setGeometry(QRect(190, 299, 91, 31));
        rememberPassword->setFont(font1);
        rememberPassword->setIconSize(QSize(12, 12));
        forgetPassword = new QPushButton(Login);
        forgetPassword->setObjectName("forgetPassword");
        forgetPassword->setGeometry(QRect(410, 300, 91, 31));
        forgetPassword->setFont(font1);
    ...
    void retranslateUi(QDialog *Login)
    {
        ...
        rememberPassword->setText(QCoreApplication::translate("Login", "\350\256\260\344\275\217\345\257\206\347\240\201", nullptr));
        forgetPassword->setText(QCoreApplication::translate("Login", "\345\277\230\350\256\260\345\257\206\347\240\201\357\274\237", nullptr));
